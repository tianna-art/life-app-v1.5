...
- linked_target_type と linked_target_id :
    ...
    **1件ずつ独立に判断すること。** 全部を同じ1つに紐づけないでください。
    画面では、この紐づけごとに変化がまとまって表示されます。
    5件が同じカードに付くと「その月は1つのことしか起きなかった」という
    絵になり、実際に起きたことと違う形になります。
    ある月が、月のテーマにも、年の方向にも、ありたい姿にも、
    さらにその外にも同時に効いているのは普通のことです。
